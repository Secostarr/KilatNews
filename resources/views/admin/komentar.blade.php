    ...
    <div class="row bg-light rounded align-items-center mx-0 p-4">
        <div class="d-flex justify-content-between align-items-center w-100">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <h3 class="mb-0 text-dark">KOMENTAR</h3>
            </div>
        ...
        <div class="comment d-flex mb-4 p-3 shadow-sm rounded">
            ...
            <div class="comment-content flex-grow-1">
                <div class="comment-header d-flex justify-content-between align-items-center mb-2">
                    ...
                    <span class="comment-time text-muted">2 jam yang lalu</span>
                </div>
                <p class="comment-text mb-2">Ini adalah contoh komentar. Komentar ini menjelaskan pendapat pengguna terkait konten yang dibaca.</p>
                <div class="comment-actions">
                    <button class="btn btn-info btn-sm me-2"><i class="fas fa-check"></i> Balas</button>
